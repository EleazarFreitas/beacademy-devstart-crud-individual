        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/student') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Meu Banco De Dados</a>
                    @else
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class='text-center'>
                    <img class='' style='width:200px;' src="https://i.imgur.com/ACgeuIp_d.webp?maxwidth=760&fidelity=grand">
                    <h1>Laravel 9 - CRUD</h1>
                    <p>#DevStart #BeAcademy</p>
                </div>
            </div>
        </div>
    </body>
